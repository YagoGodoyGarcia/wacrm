// ============================================================
// Inbound WhatsApp webhook processing — extracted from
// src/app/api/whatsapp/webhook/route.ts so the exact same logic can
// be invoked in-process by the demo-mode simulator (status ticks +
// simulated customer replies), not just by a real signed POST from
// Meta. Behavior is unchanged from the original route file; this is
