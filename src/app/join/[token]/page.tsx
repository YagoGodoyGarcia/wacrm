...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça para quem te convidou enviar um novo.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao admin da conta para enviar um novo — leva poucos segundos para gerar.',
  },
  server_error: {
